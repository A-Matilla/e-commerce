...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <nav class="mt-2">
        ...
        <li class="nav-item has-treeview {{ request()->is("admin/category") || request()->is("admin/addcategory") ? "menu-open" : "" }}">
            <a href="#" class="nav-link {{ request()->is("admin/category") || request()->is("admin/addcategory") ? "active" : "" }}">
