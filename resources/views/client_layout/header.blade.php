                    ...
                    <ul>
                        <li>
                            @if(Session::has('client'))
                                <a href="{{ url('/account') }}"><i class="fa fa-user s_color"></i> {{Session::get('client')->email}}</a>
                            @else
                                <a href="{{ url('/signin') }}"><i class="fa fa-user s_color"></i> SignIn</a>
                            @endif
                ...
                <ul>
                    ...
                    <li class="side-menu">
                        <a href="#">
                            ...
                            <span class="badge">{{ Session::has('cart') ? Session::get('cart')->totalQty : null }}</span>
                            <p>My Cart</p>
                        </a>
                    </li>
                </ul>
        ...
        <div class="side">
            ...
            <li class="cart-box">
                <ul class="cart-list">
                    ...
                    @endif
                    <li class="total">
                        <a href="{{ url('/card') }}" class="btn btn-default hvr-hover btn-cart">VIEW CART</a>
