                ...
                <div class="col-sm-6 col-lg-6 mb-3 offset-sm-3 offset-lg-3">
                    <div class="Account-address">
                        <div class="title-left">
                            ...
                            @endif
                            <h3>Sign-in / Don't have an account ? <a href="{{ url('register') }}">Register</a></h3>
                        </div>
                        <form class="needs-validation" action="{{ url('/accessaccount')}}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="email">Email Address *</label>
                                <input type="email" required name="email" class="form-control" id="email" placeholder="" required>
                                <div class="invalid-feedback"> Please enter a valid email address for shipping updates. </div>
                            </div>

                            <div class="mb-3">
                                <label for="email">Password *</label>
                                <input type="password" required name="password" class="form-control" id="email" placeholder="" required>
                                <div class="invalid-feedback"> Please enter a valid email address for shipping updates. </div>
                            </div>
